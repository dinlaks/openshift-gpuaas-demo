...
The table below is validated for **OCP 4.22 + RHOAI 3.4 and 3.5 (September 2026)**. If you are on a
...
|---|---|---|---|---|
| Red Hat OpenShift AI | `rhods-operator` | `stable-3.3` | `stable-3.4` / `stable-3.5` | Set `RHOAI_CHANNEL` |
